...
function checkImagesLoaded(node) {
...
class About extends React.Component {
  ...
  handleImageLoad() {
    if (checkImagesLoaded(this.aboutElement)) {
  ...
  render() {
    ...
    return (
      <div
        className={`about ${isLoading ? "loading" : ""}`}
        ref={(element) => { this.aboutElement = element }}
      >
        <ClipLoader color="#3b3b3b" size={100} loading={isLoading} />
        <div
        ...
        >
          <div className="about_flex-col">
            <section className="about_info">
              <h2>About me</h2>
              <img src={AboutPic} alt="pretty" onLoad={this.handleImageLoad} />
              <p>
          ...
          <section className="about_tochange">asd</section>
        </div>
      </div>
    )
  }
